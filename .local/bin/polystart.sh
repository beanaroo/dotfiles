...
export GITLAB_HEALTHCHECK='https://git.bitflip.sh/-/liveness?token=gkZjtUk-CswQyeJZbLzG'
export WEATHER_KEY="b94e766cce3b5685819fe4786ab0ccbc"
export WEATHER_CITY="2185964"
